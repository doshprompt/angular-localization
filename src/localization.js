angular.module('ngLocalize', ['ngCookies', 'ngLocalize.Config', 'ngLocalize.Events', 'ngLocalize.InstalledLanguages'])
    .provider('locale', function() {
        this.$get = ['$http', '$q', '$log', '$rootScope', '$window', '$cookieStore', 'localeConf', 'localeEvents', 'localeSupported', 'localeFallbacks',
            function ($http, $q, $log, $rootScope, $window, $cookieStore, localeConf, localeEvents, localeSupported, localeFallbacks) {
                ...
                return {
                    ready: typeof this.ready === 'function' ? readyOverride : ready,
                    isToken: isToken,
                    getPath: getPath,
                    getKey: getKey,
                    setLocale: setLocale,
